...
public class GoogleDriveService {
    ...
    public GoogleDriveService() {
        ...
        System.out.println("🔧 [INIT] Target email: vazelodie096@gmail.com");
        ...
        try {
            ...
            // Verify the credential and print user info
            if (credential != null) {
                System.out.println("✅ [AUTH] Successfully authenticated!");
                System.out.println("📧 [AUTH] Access token expires in: " +
                        (credential.getExpiresInSeconds() != null ? credential.getExpiresInSeconds() + " seconds" : "Unknown"));
            }
            ...
            // Quick API test to verify user
            System.out.println("🔧 [INIT] Testing API connection...");
            com.google.api.services.drive.model.About about = driveService.about().get().setFields("user").execute();
            String userEmail = about.getUser().getEmailAddress();
            System.out.println("✅ [INIT] API connection test successful! User: " + userEmail);

            // Verify it's the correct email
            if ("vazelodie096@gmail.com".equalsIgnoreCase(userEmail)) {
                System.out.println("✅ [INIT] Correct user account confirmed: vazelodie096@gmail.com");
            } else {
                System.out.println("⚠️ [INIT] Different user account detected: " + userEmail);
                System.out.println("⚠️ [INIT] Expected: vazelodie096@gmail.com");
            }
    ...
    public boolean isInitialized() {
        return driveService != null && parentFolderId != null;
    }
}